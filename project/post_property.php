...
<head>
   ...
   <title>Upload your new property</title>
...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="box">
         ...
         <input type="text" name="property_name" required maxlength="50" placeholder="Enter your property name" class="input">
      </div>
      <div class="flex">
         <div class="box">
         ...
         <div class="box">
            <p>Deposite advance amount <span>*</span></p>
            <input type="number" name="deposite" required min="0" max="9999999999" maxlength="10" placeholder="Enter advance deposite amount" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            <p>Number of Balcony <span>*</span></p>
      ...
      <div class="box">
         ...
         <textarea name="description" maxlength="1000" class="input" required cols="30" rows="10" placeholder="Write few words about property..."></textarea>
      </div>
      <div class="checkbox">
         <div class="box">
         ...
         <div class="box">
            ...
            <p><input type="checkbox" name="shopping_mall" value="yes" />General Store</p>
            <p><input type="checkbox" name="hospital" value="yes" />Medical Store</p>
